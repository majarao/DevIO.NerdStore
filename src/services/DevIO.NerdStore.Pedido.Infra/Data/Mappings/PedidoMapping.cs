...
namespace DevIO.NerdStore.Pedido.Infra.Data.Mappings;

public class PedidoMapping : IEntityTypeConfiguration<Domain.Pedidos.Pedido>
{
    public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Domain.Pedidos.Pedido> builder)
    {
